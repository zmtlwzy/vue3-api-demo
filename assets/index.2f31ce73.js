import{_ as f}from"./index.ea82313a.js";import{g as p,ay as c,av as r,r as s,N as F,w as t,a4 as m,o as g,j as _,Q as u,aq as E,au as C}from"./vendor.8b730130.js";const B=p({name:"MakeRaw",setup(){const o=c({});console.log(r(s(o)));const a=s({foo:o});console.log(r(a.foo));const e=c({nested:{}}),n=s({nested:e.nested});return console.log(e.nested===n.nested),console.log(e.nested,n.nested),{}}}),v=u(" \u6807\u8BB0\u4E00\u4E2A\u5BF9\u8C61\uFF0C\u4F7F\u5176\u6C38\u8FDC\u4E0D\u4F1A\u8F6C\u6362\u4E3A "),D=u("proxy"),b=u("\u3002\u8FD4\u56DE\u5BF9\u8C61\u672C\u8EAB\u3002 ");function x(o,a,e,n,R,k){const d=E,l=C,i=m;return g(),F(i,{title:o.$options.name},{footer:t(()=>[_(l,{code:`
const foo = markRaw({});
