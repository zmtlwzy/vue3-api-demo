  ...
  <div class="grid-layout-2">
    <n-card title="UseAttrs">
      <n-space vertical align="center">
        <UseAttrs class="parent-class" id="parent-id" :style="{ padding: '10px', backgroundColor: '#dfc59f' }" />
      </n-space>
    </n-card>
    <UseAttrsTsx class="parent-tsx-class" id="parent-tsx-id" :style="{ padding: '15px', backgroundColor: 'red' }" />
